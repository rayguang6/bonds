<?php
    ...
    $sql = "UPDATE resident SET ic='".$IC."', name='".$name."', dob='".$DOB."', gender='".$gender."', race='".$profile_race."', contact='".$phone_Number."', emergency_contact='".$emergency_contact."', email='".$email."' WHERE ic='".$loginIC."'";
